	...
	rest.get("https://rebrickable.com/api/v3/lego/minifigs/fig-008941", (req, res, ctx) =>
		res(
			ctx.json({
				...
				set_url: "https://rebrickable.com/minifigs/fig-008941/bellatrix-lestrange-long-black-hair-over-shoulder-black-dress-plain-skirt/",
				last_modified_dt: "2020-06-04T19:00:36.781081Z",
			})
		)
	),
	rest.get("https://rebrickable.com/api/v3/lego/minifigs/fig-008941/parts/", (req, res, ctx) => res(ctx.json(partsResponse))),
